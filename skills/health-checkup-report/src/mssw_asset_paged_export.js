 ...
 * @param {string} options.msswBaseUrl MSSW origin（如 http://mssw-inner.sangfor.com.cn:30001，由 config/api_config.json 决定）
...
async function pagedExportMsswAssetList(options) {
  ...
  const outputDir = options.outputDir || require('./workdir').getTmpExportDir();
