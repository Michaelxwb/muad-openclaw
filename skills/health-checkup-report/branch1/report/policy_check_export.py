...
# 集中 api_config：MSSW origin 默认线上，env 可覆盖
import sys as _sys
import os as _os
...
DEFAULT_BASE_URL = _get_origin("mssw")
HOST_HEADER = _get_host_header()
...
def parse_args():
    ...
    parser.add_argument("--mssw-base-url", default=None, help="MSSW 站点域名（如 http://mssw-inner.sangfor.com.cn:30001），未传时读取 config/api_config.json 默认值")
